...
-- Seed initial portal staff at deployment (Password for all: Password123!)
...
('Finance Lead', 'finance@streamflix.com', '$2a$10$kmhQ2CwcOGtN9Jay58BpWOIyAq81UkWf2GhHSh87hUJ8.bZ40wowC', 'FINANCE', 'ACTIVE'),

('Support Lead', 'support@streamflix.com', '$2a$10$kmhQ2CwcOGtN9Jay58BpWOIyAq81UkWf2GhHSh87hUJ8.bZ40wowC', 'SUPPORT', 'ACTIVE');
...
(1, 'Standard Monthly','MONTHLY', 29900,  'INR', 14, 0, 'EXCLUSIVE', '2026-01-01', 'ACTIVE'),

(1, 'Standard Yearly', 'YEARLY',  299900, 'INR', 14, 0, 'EXCLUSIVE', '2026-01-01', 'ACTIVE');
...
(5, 'IN', 'INR', 29900,  '2026-01-01'),

(5, 'US', 'USD', 799,    '2026-01-01'),

(5, 'GB', 'GBP', 599,    '2026-01-01'),

(6, 'IN', 'INR', 299900, '2026-01-01'),

(6, 'US', 'USD', 7999,   '2026-01-01'),

(6, 'GB', 'GBP', 5999,   '2026-01-01');
...
(5, 'Download Storage', 'GB', 2000, 5, 'ACTIVE'),

(6, 'Download Storage', 'GB', 2000, 5, 'ACTIVE');
