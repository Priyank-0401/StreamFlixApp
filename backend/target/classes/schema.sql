...
DROP DATABASE IF EXISTS subscription_billing;
...
VALUES (
        ...
        '$2a$10$kmhQ2CwcOGtN9Jay58BpWOIyAq81UkWf2GhHSh87hUJ8.bZ40wowC',
        'ADMIN',
        'ACTIVE'
    ),
    (
        'Finance Lead',
        'finance@streamflix.com',
        '$2a$10$kmhQ2CwcOGtN9Jay58BpWOIyAq81UkWf2GhHSh87hUJ8.bZ40wowC',
        'FINANCE',
        'ACTIVE'
    ),
...
VALUES (
        'StreamFlix',
        'Premium streaming platform with exclusive content, multi-device support, and offline downloads.',
        'ACTIVE'
    );
